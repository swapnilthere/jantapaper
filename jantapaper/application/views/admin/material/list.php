                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="<?php echo base_url() . 'admin/material/create' ?>" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp; Add Material</a>
                                    ...
                                    <?php foreach ($material_type as $categoryRow) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url() . 'admin/material/edit/' . $categoryRow['id']; ?>" class="btn btn-primary btn-sm"><i title='Edit' class='fa fa-edit'></i></a>
...
<script>
    function deleteClient(id) {
        if (confirm("Are you sure you want to delete material?")) {
            // alert(id);
            window.location.href = '<?php echo base_url() . 'admin/material/delete/'; ?>' + id
        }
    }
</script>
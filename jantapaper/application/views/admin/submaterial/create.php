        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url() . 'admin/material/index'; ?>">Sub Material</a></li>
                    <li class="breadcrumb-item active">Add New Sub Material</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary">
                    ...
                    <form action="<?php echo base_url() . 'admin/subMaterial/create' ?>" name="categoryForm" id="categoryForm" method="post">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="parent_id" class="form-control <?php echo (form_error('parent_id') != "") ? 'is-invalid' : ''; ?>">
                                            ...
                                            foreach ($material_type as $row) { ?>
                                                <option value='<?= $row['id'] ?>'><?= $row['material'] ?></option>
                                            <?php }
                                            ?>
                                        </select>

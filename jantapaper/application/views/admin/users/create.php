        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url() . 'admin/users/index'; ?>">Users</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary">
                    ...
                    <form action="<?php echo base_url() . 'admin/users/create' ?>" name="categoryForm" id="categoryForm" method="post">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">

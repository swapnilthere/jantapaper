                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="card-title">
                            Edit User "<?php echo $staffData['username'] ?>"
                        </div>

                    </div>
                    <form action="<?php echo base_url() . 'admin/users/edit/' . $staffData['id']; ?>" name="staffForm" id="staffForm" method="post">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" id="password" value="<?php echo set_value('password', $staffData['password']); ?>" class="form-control <?php echo (form_error('password') != "") ? 'is-invalid' : ''; ?>">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo base_url() . 'admin/user'; ?>" class="btn btn-secondary">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
